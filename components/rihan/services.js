    ...
    return (
      <div>
        ...
        <section class="services text-center section" id="services">
          <div class="headTitle">
            <h2>OUR SERVICES</h2>
            <svg width="210px" height="20px" class="ml-8">
              <line
                x1="0"
                y1="10"
                x2="180"
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 ">
                <div class="content">
                  ...
                  <h3 class="pt-2">Physical Examination</h3>
                  <p>
