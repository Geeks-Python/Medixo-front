...
export default class not_important extends Component {
    render() {
        return (
            <div>
                      {/* <section
      class="relative px-4 py-12 text-center bg-blue-teal-gradient sm:px-8 lg:px-16 xl:px-40 2xl:px-64 md:text-left">
      <div class="md:flex md:items-center md:justify-center">
        <h2 class="text-xl font-bold text-white">Get in touch with us today!
         <br class="block md:hidden"/>Call us on: +1562-789-1935 </h2>
        <a href="#"
          class="inline-block px-8 py-4 mt-4 font-semibold text-blue-600 bg-white rounded md:ml-8 md:mt-0">Book
          Appointment</a>
      </div>
    </section> */}
          ...
          {/* <footer class="relative px-4 py-12 text-white bg-gray-900 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-24">
            <div class="flex flex-col md:flex-row">
              <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                <h3 class="text-2xl font-bold">DentalPro</h3>
              ...
              <div class="w-full mt-8 lg:w-2/6 lg:mt-0 lg:mx-4 lg:pr-8">
                ...
                <ul class="mt-4">
                  ...
                  <li class="mt-4">
                    <a href="#" title="" class="items-center opacity-75 block-flex hover:opacity-100">
                      <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                          class="fill-current">
                          <path
